# Full Balance Hazir Paylasim Paketi
...
Bu dosyalar hazir gorseldir. Direkt TikTok/Reels kapagi, Instagram postu veya Pinterest pini olarak kullan.

1. `png/reels-cover-01-6-modul-tr.png`
   - Konu: Full Balance 6 modul tanitim.
...
Caption:
"Full Balance tamamen ücretsiz: kas gelişimi, yağ yakımı, yoga, meditasyon, reformer ve pilates tek uygulamada. Kredi kartı yok, hemen başla."

Hashtag:
`#fullbalance #fitnessuygulamasi #pilates #yoga #kasgelisimi`
...
- Uygulama ekranlari gercek.
- Mesaj sayisi az.
- Her kreatif tek konu anlatiyor.
- Ucretsiz oldugu net.
- 6 modul gorunuyor.
- Kullanici neye tiklayacagini anliyor.

## Sonraki Adim

Bu 3 gunluk setten sonra hangi konu daha cok profil ziyareti ve kayit getirirse 30 gunluk planin agirligini o module kaydir.
