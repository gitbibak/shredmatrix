...
const pageDefinitions = {
  ...
  workout: {
    ...
    es: {
      title: 'Plan Personalizado con Mancuernas', accent: 'Gratis para Casa', metaTitle: 'Plan con Mancuernas Personalizado Gratis en Casa | Full Balance',
      description: 'Crea una rutina de tonificación en casa con mancuernas, adaptada a tu nivel, objetivo y días. Plan gratis con series, repeticiones y progresión.',
      hero: 'Indica tu nivel, objetivo, mancuernas y días disponibles. Recibe una semana personalizada para casa con ejercicios, series, repeticiones, descanso y progresión.',
      sections: [['Mancuernas y espacio doméstico', 'El plan utiliza las mancuernas o bandas que declares y evita máquinas exclusivas del gimnasio.'], ['Cada sesión es clara', 'Consulta el orden, las series, repeticiones, descanso y consejos prácticos de técnica.'], ['Progreso por fases', 'Los planes avanzan por fases estructuradas según tu nivel y objetivo, en lugar de cambiar sin sentido cada semana.']],
      faqs: [['¿Sirve para tonificación en casa?', 'Sí. Elige tu objetivo, nivel y mancuernas disponibles para recibir una rutina personal con progresión clara.'], ['¿Qué peso de mancuernas necesito?', 'Empieza con una carga que permita completar el rango indicado con técnica controlada; el plan progresa según tu nivel.'], ['¿Puedo entrenar sin máquinas?', 'Sí. Esta rutina usa mancuernas, bandas opcionales y movimientos adecuados para casa, no máquinas de gimnasio.'], ['¿Incluye yoga y pilates?', 'Sí. Full Balance también crea planes de yoga, pilates, reformer y meditación.']],
    },
  },
  homeWorkout: {
