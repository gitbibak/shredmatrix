...
const exerciseDB = {
  // ── GÖĞÜS (Chest) ──────────────────────────────────────
  'bench press': { muscles: ['Göğüs', 'Triceps'], tip: 'Sırtını bankta sabit tut, dirseğini 45° aç', difficulty: 2, emoji: '🏋️' },
  'göğüs press': { muscles: ['Göğüs', 'Triceps'], tip: 'Sırtını bankta sabit tut, dirseğini 45° aç', difficulty: 2, emoji: '🏋️' },
  'dumbbell press': { muscles: ['Göğüs', 'Omuz'], tip: 'Ağırlığı kontrollü indir, göğüs hizasında dur', difficulty: 2, emoji: '🏋️' },
  'dumbbell fly': { muscles: ['Göğüs'], tip: 'Kolları hafif bükük tut, gerimi hisset', difficulty: 2, emoji: '🦋' },
  ...
  'cable crossover': { muscles: ['Göğüs'], tip: 'Kolları çapraz getir, sıkışmayı hisset', difficulty: 2, emoji: '🔗' },
  ...
  // ── SIRT (Back) ─────────────────────────────────────────
  'barbell row': { muscles: ['Sırt', 'Biceps'], tip: 'Sırtını düz tut, barı göbeğe çek', difficulty: 2, emoji: '🏋️' },
  'sırt çekişi': { muscles: ['Sırt', 'Biceps'], tip: 'Sırtını düz tut, dirsekleri geri çek', difficulty: 2, emoji: '🏋️' },
  'lat pulldown': { muscles: ['Sırt'], tip: 'Göğse doğru çek, kürek kemiklerini sık', difficulty: 1, emoji: '⬇️' },
  'lat çekiş': { muscles: ['Sırt'], tip: 'Göğse doğru çek, kürek kemiklerini sık', difficulty: 1, emoji: '⬇️' },
  'pull-up': { muscles: ['Sırt', 'Biceps'], tip: 'Çeneyi barın üstüne getir, kontrollü in', difficulty: 3, emoji: '💪' },
  ...
  'deadlift': { muscles: ['Sırt', 'Bacak'], tip: 'Sırt düz! Kalçadan kaldır, dizlerden değil', difficulty: 3, emoji: '🔥' },
  ...
  'face pull': { muscles: ['Arka Omuz', 'Sırt'], tip: 'Halatı yüze doğru çek, dirsekler yukarı', difficulty: 1, emoji: '🔗' },
  'hyperextension': { muscles: ['Alt Sırt'], tip: 'Kontrollü in ve kalk, ani hareket yapma', difficulty: 1, emoji: '🔄' },

  // ── OMUZ (Shoulders) ────────────────────────────────────
  'overhead press': { muscles: ['Omuz', 'Triceps'], tip: 'Çekirdek kaslarını sık, barı başın üstüne itin', difficulty: 2, emoji: '⬆️' },
  'omuz press': { muscles: ['Omuz', 'Triceps'], tip: 'Sırtını dik tut, barı başın üstüne itin', difficulty: 2, emoji: '⬆️' },
  'lateral raise': { muscles: ['Yan Omuz'], tip: 'Kolları omuz hizasına kadar kaldır, yavaş indir', difficulty: 1, emoji: '🦅' },
  ...
  // ── BACAK (Legs) ────────────────────────────────────────
  'squat': { muscles: ['Quadriceps', 'Kalça'], tip: 'Dizleri ayak uçlarının önüne geçirme, derin çömel', difficulty: 2, emoji: '🦵' },
  'squat (çömelme)': { muscles: ['Quadriceps', 'Kalça'], tip: 'Dizleri ayak uçlarının önüne geçirme', difficulty: 2, emoji: '🦵' },
  'leg press': { muscles: ['Quadriceps'], tip: 'Sırtını yastığa daya, dizleri 90°ye kadar bük', difficulty: 1, emoji: '🦵' },
  ...
  'lunge': { muscles: ['Quadriceps', 'Kalça'], tip: 'Dik dur, ön diz 90° olsun, arka diz yere yakın', difficulty: 2, emoji: '🚶' },
  ...
  'hip thrust': { muscles: ['Kalça'], tip: 'Kalçayı sık, üst pozisyonda 2sn tut', difficulty: 2, emoji: '🍑' },
  'romanian deadlift': { muscles: ['Hamstring', 'Kalça'], tip: 'Bacaklar hafif bükük, kalçadan eğil', difficulty: 2, emoji: '🏋️' },
  'hack squat': { muscles: ['Quadriceps'], tip: 'Sırtını makineye daya, derin çömel', difficulty: 2, emoji: '🦵' },

  // ── KOL (Arms) ──────────────────────────────────────────
  'bicep curl': { muscles: ['Biceps'], tip: 'Dirseğini sabit tut, sadece ön kolu hareket ettir', difficulty: 1, emoji: '💪' },
  ...
  'triceps pushdown': { muscles: ['Triceps'], tip: 'Dirseği sabit tut, aşağı it', difficulty: 1, emoji: '⬇️' },
  ...
  // ── KARINN (Core/Abs) ───────────────────────────────────
  'plank': { muscles: ['Core'], tip: 'Gövde düz, kalça düşmesin, nefes al', difficulty: 1, emoji: '🧱' },
  'crunch': { muscles: ['Karın'], tip: 'Omuzları yerden kaldır, boynu zorlamadan', difficulty: 1, emoji: '🔥' },
  'russian twist': { muscles: ['Yan Karın'], tip: 'Ayakları yerden kaldır, sağa sola dön', difficulty: 2, emoji: '🔄' },
  'leg raise': { muscles: ['Alt Karın'], tip: 'Bacakları dik kaldır, yavaş indir', difficulty: 2, emoji: '🦵' },
