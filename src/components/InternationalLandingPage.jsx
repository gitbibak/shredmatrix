...
import { findInternationalSeoPage, getInternationalRelatedPages } from '../data/internationalSeoPages';
...
export default function InternationalLandingPage({ pathname }) {
  ...
  const registerUrl = `/auth?mode=register&lang=${page.lang}&source=international-seo`;
