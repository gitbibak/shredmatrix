...
const copy = {
  ...
  tr: {
    metric: 'Metrik', imperial: 'İngiliz', female: 'Kadın', male: 'Erkek', age: 'Yaş', height: 'Boy', weight: 'Kilo', feet: 'Fit', inches: 'İnç', activity: 'Aktivite', goal: 'Hedef', calculate: 'Hesapla', result: 'Tahminin', bmr: 'Bazal metabolizma (BMR)', tdee: 'Koruma kalorisi', calories: 'Hedef kalori', protein: 'Protein', carbs: 'Karbonhidrat', fat: 'Yağ', perDay: 'günlük', save: 'Ücretsiz planıma kaydet', range: 'Önerilen günlük aralık', bmi: 'BMI değerin', context: 'Yetişkin tarama kategorisi', underweight: 'Standart aralığın altında', healthy: 'Standart aralık', overweight: 'Standart aralığın üstünde', obesity: 'Standart aralığın çok üstünde', note: 'Bu bir tahmindir; tanı veya tıbbi reçete değildir.', activities: ['Çoğunlukla hareketsiz', 'Hafif aktif (haftada 1-3 gün)', 'Orta aktif (haftada 3-5 gün)', 'Yüksek aktif (haftada 6-7 gün)', 'Çok yüksek aktivite'], goals: ['Kiloyu koru', 'Yağ yak', 'Kas kazan'], errors: 'Hesaplamak için geçerli değerler gir.'
  },
  es: {
