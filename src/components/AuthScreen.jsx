          ...
          {!isForgot && (
            <div className="mt-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xs text-slate-600 font-inter">{t('auth.orContinueWith') || 'veya'}</span>
                <div className="flex-1 h-px bg-slate-800" />
              </div>
              <motion.button
                type="button"
                ...
                className="w-full flex items-center justify-center gap-2.5 py-3 rounded-xl bg-white text-slate-800 text-sm font-semibold font-outfit shadow-lg hover:bg-slate-50 transition-all cursor-pointer"
              >
